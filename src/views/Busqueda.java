		...
		btnbuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (!txtBuscar.getText().isEmpty()) {
					...
					cargarHuespedPorBusqueda(criterio);
					cargarReservaPorBusqueda(criterio);
				}else {
					modeloHuesped.getDataVector().clear();
					modelo.getDataVector().clear();
					cargarHuespedes();
...
//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    public void cargarReservaPorBusqueda(String criterio) {
	    	List<Reserva> reservas = reservaController.listarPorCriterio(criterio);
	    	try {
		    	reservas.forEach(reserva -> modelo.addRow(new Object[] {
		    			reserva.getId(), reserva.getFechaEntrada(), reserva.getFechaSalida(),
		    			reserva.getValor(), reserva.getFormapago()
	    ...
	    public void cargarHuespedPorBusqueda(String criterio){
	    	List<Huesped> huespedes = huespedController.listarPorCriterio(criterio); 
	    	try {
	    		huespedes.forEach(huesped -> modeloHuesped.addRow(new Object[] {
		    			huesped.getId(), huesped.getNombre(), huesped.getApellido(), huesped.getFechaNacimiento()
		    	    		, huesped.getNacionalidad(), huesped.getTelefono(), huesped.getIdReserva()
