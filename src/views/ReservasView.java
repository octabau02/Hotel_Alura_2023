...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		JLabel lblentrar = new JLabel("Siguiente");
		lblentrar.setBounds(0, -5, 122, 44);
		JPanel btnsiguiente = new JPanel();
		btnsiguiente.add(lblentrar);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					Reserva reserva = new Reserva(txtFechaEntrada.getDate(), txtFechaSalida.getDate(), Double.valueOf(txtValor.getText()), (String)txtFormaPago.getSelectedItem());
				
					reservacontroler.hacerReservacion(reserva);
		...
		txtFechaEntrada.addPropertyChangeListener(new PropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent evt) {
				if ("date".equals(evt.getPropertyName())) {
					 txtValor.setText(reservacontroler.calculateValue(
							 txtFechaEntrada, txtFechaSalida));
				}
